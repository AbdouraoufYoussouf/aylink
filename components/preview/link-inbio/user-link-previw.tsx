...
import UserLinkPreviewSkeleton from './link-user-preview-skeleton'
...
export default function UserLinkPreviw({ pseudo }: Props) {
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center">
      ...
      <motion.div
        ...
        className="w-full max-w-lg border  sm:rounded-lg shadow-xl overflow-hidden"
      >
