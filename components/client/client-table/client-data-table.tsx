...
import { getAllClientFilterAction } from "@/actions/client-action"
...
export function ClientDataTable({
    columns, searchPlaceholder,}: DataTableProps<ClientType, unknown>) {
    ...
    const { isLoading, data, refetch } = useQuery({
        queryKey: ['clients'],
        queryFn: async () => {
            const res = await getAllClientFilterAction({
                search: searchTerm,
            })
